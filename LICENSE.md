...
(e) **Use the brand assets** — including but not limited to the marks "Yellow Jacket Tour", "Yellow Jacket", "Honey-Stroke", "Sweet Stroke", "Bumblebee", "Buzz", and the eight-beat hand-structure marks — in any commercial product, service, branding, advertising, marketing, social media account, domain name, or any context that could create confusion about source, sponsorship, or affiliation with the Licensor.

(f) **Use the rule system or game mechanics** — including but not limited to the Honey-Stroke law, the agreed-total wagering primitive, the round-divisor normalization, the dual-variant system, the eight-beat hand structure, and the survival-cushion handicap — in any commercial competing product. The mechanics may be discussed and analyzed (per §2 fair-use rights) but not implemented or commercially deployed.
...
This License was last updated on **2026-05-02**. The Licensor reserves the right to amend this License for future versions of the Work; Your use of any specific version of the Work is governed by the License in effect at the time of Your access.
