...
Per-round formula (Codex §1.3) normalizes honey by dynamic divisor (72/18/9/1). Tournament formats, field selection (champ exemptions 3 years, merit \+ mixed open qualifiers), and economics (3% rake to Foundation, geometric payout decay 0.74) are verbatim from DEFAULT\_SIM\_CONFIG \~6480 and selectMajorField \~2869.
